    ...
    <nav className="w-full bg-white text-[#111] relative">
      ...
      <div className="bg-[#f5f5f5] px-4 md:px-8 py-2 flex justify-between items-center text-xs md:text-sm">
        ...
        <div className="hidden md:flex gap-4">
          <button onClick={() => navigate('/')} className="hover:text-gray-500">Find a Store</button>
          <span className="text-gray-400">|</span>
          <button onClick={() => navigate('/contactus')} className="hover:text-gray-500">Help</button>
          <span className="text-gray-400">|</span>
          <button onClick={() => navigate('/joinus')} className="hover:text-gray-500">Join Us</button>
          <span className="text-gray-400">|</span>
          <button onClick={() => navigate('/signin')} className="hover:text-gray-500">Sign In</button>
        </div>
        {/* Mobile Sign In */}
        ...
        <div className="lg:hidden fixed inset-0 bg-white z-50">
          ...
          <div className="h-full overflow-y-auto">
            ...
            <div className="border-t border-gray-200 px-6 py-4 space-y-3">
              ...
              <a href="/contactus" className="block hover:text-gray-500">Help</a>
              <a href="/joinus" className="block hover:text-gray-500">Join Us</a>
            </div>
          </div>
        </div>
      )}
