...
const AddToCart = ({ product, selectedSize }: AddToCartProps) => {
  ...
  return (
    <div className="relative">
      <button
        ...
        disabled={isAdding}
        className="w-[177.42px] h-[60px] bg-black text-white rounded-full px-6 font-medium hover:bg-gray-800 transition-colors duration-200 flex items-center justify-center gap-2"
      >
        {isAdding ? 'Adding...' : (
          <>
      ...
      {showNotification && (
        <div className="absolute top-[-60px] left-0 right-0 bg-green-500 text-white px-4 py-3 rounded-lg text-center animate-fade-in-out">
